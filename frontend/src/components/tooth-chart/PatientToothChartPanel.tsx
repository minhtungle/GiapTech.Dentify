...
export function PatientToothChartPanel({ patientId }: PatientToothChartPanelProps) {
  ...
  const loadData = async () => {
    ...
    setLoadError(false)
    try {
      const chartResult = await toothChartApi.get(patientId)
      ...
      {!isLoading && chart && (
        <>
          <div className="flex items-center justify-between">
            ...
            {chart.isChildPatient && <Badge variant="secondary">Răng sữa</Badge>}
          </div>
