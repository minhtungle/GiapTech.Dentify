...
public class DentifyDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        DentifyGlobalFeatureConfigurator.Configure();
        DentifyModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.Resources
                .Add<DentifyResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Dentify");
        ...
        {
            options.MapCodeNamespace("Dentify", typeof(DentifyResource));
        });
    }
}
